...
ImporterApp.prototype.Init = function ()
{
	...
	this.importerButtons.AddLogo ('Nevşehir Hacı Bektaş Veli Üniversitesi <span class="version">Kampüs 3D</span>');
...
{
	var welcomeText = [
		'<div class="welcometitle">Nevşehir Hacı Bektaş Veli Üniversitesi | KAMPÜS 3D</div>',
		'<div class="">Görüntülemek istediğiniz dosyayı "Gözat" diyerek açmanız gerekmektedir. </div>',
...
ImporterApp.prototype.ProcessFiles = function (fileList, isUrl)
{
	...
	processorFunc (userFiles, {
		onError : function () {
			myThis.GenerateError ('Okunabilir dosya bulunamadı. 3ds, obj, stl ve off dosyalarını açabilirsiniz.');
